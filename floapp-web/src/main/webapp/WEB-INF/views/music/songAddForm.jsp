		...
		<div class="container">
			<form action="/admin/songAdd" method="post" enctype="multipart/form-data" name="contact" id="contact-form">
				<div class="field">
					...
					<input name="artist" type="text" class="required" title="Please type Artist Name !" placeholder="가수 이름 ...">
				</div>

				<div class="field">
					<p>Title (노래제목) <span class="colored">*</span></p>
					<input name="title" type="text" class="required" title="Please type Title !" placeholder="노래 제목 ...">
				</div>

				<div class="field">
					<p>ReleaseDate (발매날짜) <span class="colored">*</span></p> 
					<input name="relaseDate" type="text" class="required" title="Please type your ReleasDate !" placeholder="ex) 2021.3 , 2020.5.13 (년.월.일) 로 작성해주세요">
				</div>
