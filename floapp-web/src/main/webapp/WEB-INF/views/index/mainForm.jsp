...
<div class="container">
	...
	<div id="albums" class="container section featured-albums-home">
		...
		<div class="albums row">
			<div class="col-sm-4">
				<div class="album">
					<img src="/image/IU (아이유) - 라일락.png" alt="cover" class="img-responsive">
					<div class="cd-mask">
						<div class="center"></div>
					</div>
					<div class="info">
						<a class="album-name" href="/album/10">라일락 <i class="fa fa-arrow-circle-right"></i></a>
						<br>
						<p>아이유(IU)</p>
					</div>
				</div>
			...
			<div class="col-sm-4">
				<div class="album">
					<img src="/image/제시 (Jessi) - 어떤X.png" alt="cover" class="img-responsive">
					<div class="cd-mask">
						<div class="center"></div>
					</div>
					<div class="info">
						<a class="album-name" href="/album/33">어떤X <i class="fa fa-arrow-circle-right"></i></a>
						<br>
						<p>제시 (Jessi)</p>
					</div>
				</div>
			...
			<div class="col-sm-4">
				<div class="album">
					<img src="/image/ROSE(로제) - On The Ground.png" alt="cover" class="img-responsive">
					<div class="cd-mask">
						<div class="center"></div>
					</div>
					<div class="info">
						<a class="album-name" href="/album/53">On The Ground <i class="fa fa-arrow-circle-right"></i></a>
						<br>
						<p>ROSE (로제)</p>
					</div>
				</div>
			...
			<div class="col-sm-4">
				<div class="album">
					<img src="/image/ASH ISLAND - 멜로디.png" alt="cover" class="img-responsive">
					<div class="cd-mask">
						<div class="center"></div>
					</div>
					<div class="info">
						<a class="album-name" href="/album/34">멜로디<i class="fa fa-arrow-circle-right"></i></a>
						<br>
						<p>ASH ISLAND</p>
					</div>
				</div>
			...
			<div class="col-sm-4">
				<div class="album">
					...
					<div class="info">
						<a class="album-name" href="/album/51">Celebrity<i class="fa fa-arrow-circle-right"></i></a>
						<br>
						<p>아이유 (IU)</p>
					</div>
				</div>
			...
			<div class="col-sm-4">
				<div class="album">
					<img src="/image/양다일 - 아파.png" alt="cover" class="img-responsive">
					<div class="cd-mask">
						<div class="center"></div>
					</div>
					<div class="info">
						<a class="album-name" href="/album/12">아파<i class="fa fa-arrow-circle-right"></i></a>
						<br>
						<p>양다일</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-sm-3 artist">
					<div class="artist-wrapper">
						<img src="/assets/img/category/category-pop.jpg" alt="Artist" class="img-responsive">
						<div class="mask">
							<h1>POP</h1>
							<p>Pop Collection</p>
							<ul class="social">
				...
				<div class="col-sm-3 artist">
					<div class="artist-wrapper">
						<img src="/assets/img/category/category-ballad.jpg" alt="Artist" class="img-responsive">
						<div class="mask">
							<h1>BALLAD</h1>
				...
				<div class="col-sm-3 artist">
					<div class="artist-wrapper">
						<img src="/assets/img/category/category-dance.jpg" alt="Artist" class="img-responsive">
						<div class="mask">
							<h1>DANCE</h1>
				...
				<div class="col-sm-3 artist">
					<div class="artist-wrapper">
						<img src="/assets/img/category/category-hiphop.jpg" alt="Artist" class="img-responsive">
						<div class="mask">
							<h1>HIPHOP</h1>
