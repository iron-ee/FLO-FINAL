...
//				+ "나 나나나 난난 난난나 나나난나";
//		
//		String ballade_lyrics10 = "나리는 꽃가루에 눈이 따끔해 (아야)</p>"
//				+ "<p>눈물이 고여도 꾹 참을래</p>"
//				+ "<p>내 마음 한켠 비밀스런 오르골에 넣어두고서</p>"
//				+ "<p>영원히 되감을 순간이니까</p>"
//				+ "<p>우리 둘의 마지막 페이지를 잘 부탁해</p>"
//				+ "<p>어느 작별이 이보다 완벽할까</p>"
//				+ "<p>Love me only till this spring</p>"
//				+ "<p>오 라일락 꽃이 지는 날 good bye</p>"
//				+ "<p>이런 결말이 어울려</p>"
//				+ "<p>안녕 꽃잎 같은 안녕</p>"
//				+ "<p>하이얀 우리 봄날의 climax</p>"
//				+ "<p>아 얼마나 기쁜 일이야</p>"
//				+ "<p></p>"
//				+ "<p>Ooh ooh</p>"
//				+ "<p>Love me only till this spring</p>"
...
//				+ "<p>Love me only till this spring</p>"
//				+ "<p>봄바람처럼</p>"
//				+ "<p>기분이 달아 콧노래 부르네 (랄라)</p>"
//				+ "<p>입꼬리는 살짝 올린 채</p>"
//				+ "<p>어쩜 이렇게 하늘은 더 바람은 또 완벽한 건지</p>"
//				+ "<p>오늘따라 내 모습 맘에 들어</p>"
//				+ "<p>처음 만난 그날처럼 예쁘다고 말해줄래</p>"
//				+ "<p>어느 이별이 이토록 달콤할까</p>"
//				+ "<p>Love resembles misty dream</p>"
//				+ "<p>오 라일락 꽃이 지는 날 good bye</p>"
//				+ "<p>이런 결말이 어울려</p>"
//				+ "<p>안녕 꽃잎 같은 안녕</p>"
//				+ "<p>하이얀 우리 봄날의 climax</p>"
...
//				+ "<p>너의 대답이 날 울려</p>"
//				+ "<p>안녕 약속 같은 안녕</p>"
//				+ "<p>하이얀 우리 봄날에 climax</p>"
//				+ "<p>아 얼마나 기쁜 일이야</p>"
//				+ "<p></p>"
//				+ "<p>Ooh ooh</p>"
//				+ "<p>Love me only untill this spring</p>"
//				+ "<p>봄바람처럼</p>"
//				+ "<p>Ooh ooh</p>"
//				+ "<p>Love me only untill this spring</p>"
//				+ "<p>봄바람처럼</p>"
...
//				+ "너도 기억하고 있는지 지금도";
//		
//		String dance_lyrics6 = "그 날을 잊지 못해 babe</p>" // 브레이브걸스 - 롤린
//				+"<p>날 보며 환히 웃던 너의 미소에</p>"
//				+"<p>홀린 듯 I'm fall in love</p>"
//				+"<p>But 너무 쪽팔림에 (난 그저)</p>"
//				+"<p>한마디 말도 못해 babe</p>"
//				+"<p>I wanna you 너의 눈빛은</p>"
//				+"<p>날 자꾸 네 곁을 맴돌게 해</p>"
//				+"<p>Just only you 굳게 닫힌 내 맘이</p>"
//				+"<p>어느새 무너져버려 Because of you</p>"
//				+"<p>온통 너의 생각뿐이야 나도 미치겠어</p>"
//				+"<p>너무 보고 싶어 매일 매일 매일</p>"
//				+"<p>자꾸 초라해지잖아 내 모습이</p>"
//				+"<p>그대여 내게 말해줘 사랑한다고</p>"
//				+"<p>Rollin' Rollin' Rollin' Rollin'</p>"
//				+"<p>Rollin' Rollin' Rollin' Rollin'</p>"
//				+"<p>Rollin' Rollin' Rollin' Rollin'</p>"
//				+"<p>하루가 멀다 하고 Rolling in the deep</p>"
//				+"<p>Rollin' Rollin' Rollin' Rollin'</p>"
//				+"<p>Rollin' Rollin' Rollin' Rollin'</p>"
//				+"<p>기다리고 있잖아 Babe Just only you</p>"
//				+"<p>기다리고 있잖아 Babe Just only you</p>"
//				+"<p>Hey I just wanna be with you</p>"
//				+"<p>오늘 밤이 가기 전에</p>"
//				+"<p>I can't feel you 조금 더 다가와 줘</p>"
//				+"<p>Tonight I'm ready for you</p>"
//				+"<p>You wanna touch me I know</p>"
//				+"<p>대체 뭘 고민해 빨리 안아</p>"
//				+"<p>아닌 척 모르는 척 하다가</p>"
//				+"<p>늦게 놓치고 후회 말아</p>"
//				+"<p>I wanna you 너의 눈빛은</p>"
...
//				+"함께 하고 싶다고\n";
//		
//		String ballade_lyrics21 = "Breeze</p>" // 폴킴 - 커피한잔할래요
//				+"<p>가벼운 바람이 깨우는 Oh breeze</p>"
//				+"<p>너의 생각으로 시작하는</p>"
//				+"<p>My everyday</p>"
//				+"<p></p>"
//				+"<p>Breathe</p>"
//				+"<p>뭔가 좋은 일이 생길 것 같은</p>"
//				+"<p>절로 콧노래가 흘러나오는</p>"
//				+"<p>그런 상상을 하게 해</p>"
//				+"<p>단둘이서 영화를 보자 할까</p>"
//				+"<p>시시하진 않을까</p>"
...
//				+"<p>커피 한잔할래요</p>"
//				+"<p><p>커피 한잔할래요</p>"
//				+"<p><p>두 입술 꼭 깨물고 용기 낸 그 말</p>"
//				+"<p>커피 한잔에 빌린 그대를 향한 나의 맘</p>"
//				+"<p>보고 싶었단 말하고 싶었죠</p>"
//				+"<p>그대도 같나요</p>"
//				+"<p>그대 나와 같나요</p>"
//				+"<p>그대도 조금은 내 생각 했나요</p>"
//				+"<p>오늘은 내가 그댈 더 많이</p>"
//				+"<p>웃게 할게요</p>"
//				+"<p>이대로 시간이 멈추길</p>"
//				+"<p></p>"
//				+"<p>Freeze</p>"
//				+"<p>그저 흘러가는 시간들 Oh freeze</p>"
//				+"<p>처음과는 많이 다른 요즘 너와 나</p>"
//				+"<p>처음 느꼈던 가슴속 떨림</p>"
//				+"<p>넌 기억할는지</p>"
//				+"<p>처음 만났던 그곳에 가자</p>"
//				+"<p>추억이 가득한</p>"
...
//				+"<p>커피 한잔할래요</p>"
//				+"<p>커피 한잔할래요</p>"
//				+"<p>두 입술 꼭 깨물고 용기 낸 그 말</p>"
//				+"<p>커피 한잔에 빌린 그대를 향한 나의 맘</p>"
//				+"<p>보고 싶었단 말하고 싶었죠</p>"
//				+"<p>그대도 같나요</p>"
//				+"<p>그대 나와 같나요</p>"
//				+"<p>가끔 그날의 우릴 생각하나요</p>"
//				+"<p>내가 더 많이 웃게 해 주겠다는</p>"
//				+"<p>그 약속</p>"
//				+"<p>아직 나 잊지 않았어요</p>"
//			    +"<p></p>"
//				+"<p>커피 한잔할래요</p>"
...
//				+"옳아 쿵쿵거리는 나의 지금이\n";
//		
//		String dance_lyrics15 = "Ah 날 똑바로 쳐다봐</p>" // 선미 - 꼬리 (TAIL)
//				+"<p>처진 고개를 더 세워</p>"
//				+"<p>Umm 온 신경이 곤두서</p>" 
//				+"<p>이건 아마도 널</p>" 
//				+"<p>할퀸 순간부터겠지</p>"
//			    +"<p></p>"
//				+"<p>Do it Baby It's okay</p>"
//				+"<p>세상을 가진 것 마냥</p>"
//				+"<p>이기적이게 그냥 Ha Ha Ha</p>"
//				+"<p>뭐가 좋은데 그리 웃어대는데</p>"
//				+"<p>Make it right Till I die baby</p>" 
//				+"<p>Aww aww aww</p>" 
//				+"<p>Aww aww aww</p>"
//			    +"<p></p>"
//				+"<p>딱 거기까지만 Oh</p>"
...
//				+"<p>흔들어 흔들어</p>"
//			    +"<p></p>"
//				+"<p>I'm not much of a drinker</p>"
//				+"<p>But I'm a dream girl Yeah</p>"
//				+"<p>물음표? 물음표?</p>"
//				+"<p>그만 좀 물어 대</p>"
//				+"<p>니 마지막 말에 꼬리치면</p>"
//				+"<p>따다딱 거기까지만</p>" 
...
//					//BALLADE
//					new Song( "나랑 아니면", "검정치마", CategoryType.BALLADE,  ballade_lyrics1, "2017.05", "검청치마 - 나랑 아니면.png", "검정치마 - 나랑 아니면.mp3"),
//					new Song( "정류장", "버스커 버스커", CategoryType.BALLADE,  ballade_lyrics2, "2011.10", "버스커 버스커 - 정류장.png", "버스커버스커 - 정류장.mp3"),
//					new Song( "비켜줄께", "브라운아이드소울", CategoryType.BALLADE,  ballade_lyrics3, "2010.03", "브라운 아이드 소울 - 비켜줄께.png", "브라운아이드소울 - 비켜줄께.mp3"),
//					new Song( "그사람", "이승철", CategoryType.BALLADE,  ballade_lyrics4, "2010.07", "이승철 - 그 사람.png", "이승철 - 그사람.mp3"),
//					new Song( "잊었니", "이승철", CategoryType.BALLADE,  ballade_lyrics5, "2012.02", "이승철 - 잊었니.png", "이승철 - 잊었니.mp3"),
//					new Song( "그땐 미쳐 알지 못했지", "이적", CategoryType.BALLADE,  ballade_lyrics6, "2003.05", "그땐 미쳐 알지 못했지 - 이적.png", "이적 - 그땐 미처 알지 못했지.mp3"),
//					new Song( "Hello", "허각", CategoryType.BALLADE,  ballade_lyrics7, "2011.09", "허각 - hello.png", "허각 - Hello.mp3"),
//					new Song( "내 손을 잡아", "IU (아이유)", CategoryType.BALLADE, ballade_lyrics8, "2011.05", "IU (아이유) - 내 손을 잡아.png", "IU (아이유) - 내 손을 잡아.mp3"),
//					new Song( "밤하늘의 별을(2020)", "경서", CategoryType.BALLADE, ballade_lyrics9, "2020.11", "경서 - 밤하늘의 별을(2020).png", "경서 - 밤하늘의 별을(2020).mp3"),
//					new Song( "라일락", "IU (아이유)", CategoryType.BALLADE, ballade_lyrics10, "2021.03", "IU (아이유) - 라일락.png", "IU (아이유) - 라일락.mp3"),
//					new Song( "어떻게 이별까지 사랑하겠어, 널 사랑하는 거지", "AKMU (악동뮤지션)", CategoryType.BALLADE, ballade_lyrics11, "2019.09", "AKMU (악동 뮤지션) - 어떻게 이별까지 사랑하겠어, 널 사랑하는 거지.png", "AKMU (악동 뮤지션) - 어떻게 이별까지 사랑하겠어, 널 사랑하는 거지.mp3"),
//					new Song( "아파", "양다일", CategoryType.BALLADE, ballade_lyrics12, "2021.01", "양다일 - 아파.png", "양다일 - 아파.mp3"),
//					new Song( "처음처럼", "M.C the MAX (엠씨더맥스)", CategoryType.BALLADE, ballade_lyrics13, "2020.03", "M.C the MAX (엠씨더맥스) - 처음처럼.png", "M.C the MAX (엠씨더맥스) - 처음처럼.mp3"),
//					new Song( "사랑 못해, 남들 쉽게 다 하는 거", "먼데이 키즈 (Monday Kiz)", CategoryType.BALLADE, ballade_lyrics14, "2020.10", "먼데이 키즈 (MondayKiz) - 사랑 못해, 남들 쉽게 다 하는 거.png", "먼데이 키즈 (MondayKiz) - 사랑 못해, 남들 쉽게 다 하는 거.mp3"),
//					new Song( "BrownCity", "브라운아이드소울", CategoryType.BALLADE, ballade_lyrics15, "2003.09", "브라운아이드소울 - BrownCity.png", "브라운아이드소울 - BrownCity.mp3"),
//					new Song( "IF YOU", "빅뱅", CategoryType.BALLADE, ballade_lyrics16, "2015.07", "빅뱅 - IF YOU.png", "빅뱅 - IF YOU.mp3"),
//					new Song( "그대네요", "성시경", CategoryType.BALLADE, ballade_lyrics17, "2010.09", "성시경 - 그대네요.png", "성시경 - 그대네요.mp3"),
//					new Song( "말하는대로", "처진달팽이", CategoryType.BALLADE, ballade_lyrics18, "2011.07", "처진달팽이 - 말하는대로.png", "처진달팽이 - 말하는대로.mp3"),
//					new Song( "나에게로 초대", "하트여왕", CategoryType.BALLADE, ballade_lyrics19, "2016.11", "하트여왕 - 나에게로의 초대.png", "하트여왕 - 나에게로의 초대.mp3"),
//					
//					new Song( "취기를 빌려 (취향저격 그녀 X 산들)", "산들", CategoryType.BALLADE, ballade_lyrics20, "2020. 07", "산들 - 취기를 빌려 (취향저격 그녀 X 산들).jpg", "산들 - 취기를 빌려 (취향저격 그녀 X 산들).mp3"),
//					new Song( "커피한잔할래요", "폴킴", CategoryType.BALLADE, ballade_lyrics21, "2019. 07", "폴킴 - 커피한잔할래요.jpg", "폴킴 - 커피한잔할래요.mp3"),
//					new Song( "이름에게", "IU (아이유)", CategoryType.BALLADE, ballade_lyrics22, "2017. 04", "IU (아이유) - 팔레트.jpg", "IU (아이유) - 이름에게.mp3"),
//					new Song( "첫눈처럼 너에게 가겠다", "에일리", CategoryType.BALLADE, ballade_lyrics23, "2017. 01", "에일리 - 첫눈처럼 너에게 가겠다.jpg", "에일리 - 첫눈처럼 너에게 가겠다.mp3"),
//					new Song( "자장가", "IU (아이유)", CategoryType.BALLADE, ballade_lyrics24, "2019. 11", "IU (아이유) - Love poem.jpg", "IU (아이유) - 자장가.mp3"),
//					new Song( "다 그렇지 뭐", "헤이즈 (Heize)", CategoryType.BALLADE, ballade_lyrics25, "2020. 02", "헤이즈 (Heize) - 다 그렇지 뭐.jpg", "헤이즈 (Heize) - 다 그렇지 뭐.mp3"),
//					
//					//HIPHOP
//					new Song( "너도", "로꼬", CategoryType.HIPHOP,  hiphop_lyrics1, "2016.04", "로꼬 - 너도.png", "로꼬 - 너도.mp3"),
//					new Song( "행복", "오반", CategoryType.HIPHOP,  hiphop_lyrics2, "2018.12", "오반 - 행복.png", "오반 - 행복.mp3"),
//					new Song( "Boat", "죠지", CategoryType.HIPHOP,  hiphop_lyrics3, "2017.11", "죠지 - Boat.png", "죠지 - Boat.mp3"),
//					new Song( "VVS", "SMTM9", CategoryType.HIPHOP, hiphop_lyrics4, "2020.11", "SMTM9 - VVS.png", "SMTM9 - VVS.mp3"),
//					new Song( "METEOR", "창모", CategoryType.HIPHOP, hiphop_lyrics5, "2019.11", "창모 - METEOR.png", "창모 - METEOR.mp3"),
//					new Song( "Life Goes On", "BTS (방탄소년단)", CategoryType.HIPHOP, hiphop_lyrics6, "2020.11", "BTS (방탄소년단) - Life Goes On.png", "BTS (방탄소년단) - Life Goes On.mp3"),
//					new Song( "내일이 오면", "SMTM9", CategoryType.HIPHOP, hiphop_lyrics7, "2020.12", "SMTM9 - 내일이 오면.png", "SMTM9 - 내일이 오면.mp3"),
//					new Song( "어떤X", "제시 (Jessi)", CategoryType.HIPHOP, hiphop_lyrics8, "2021.03", "제시 (Jessi) - 어떤X.png", "제시 (Jessi) - 어떤X.mp3"),
//					new Song( "멜로디", "ASH ISLAND", CategoryType.HIPHOP, hiphop_lyrics9, "2021.03", "ASH ISLAND - 멜로디.png", "ASH ISLAND - 멜로디.mp3"),
//					
//					new Song( "널 너무 모르고", "헤이즈 (Heize)", CategoryType.HIPHOP, hiphop_lyrics10, "2017.06", "헤이즈 (Heize) - 너 먹구름 비.jpg", "헤이즈 (Heize) - 널 너무 모르고.mp3"),
//					new Song( "비누", "비비 (BIBI)", CategoryType.HIPHOP, hiphop_lyrics11, "2019.05", "비비 (BIBI) - 비누.jpg", "비비 (BIBI) - 비누.mp3"),
//					new Song( "연애소설 (Feat. 아이유)", "에픽하이", CategoryType.HIPHOP, hiphop_lyrics12, "2019.05", "에픽하이 - 연애소설 (Feat. 아이유).jpg", "에픽하이 - 연애소설 (Feat. 아이유).mp3"),
//					new Song( "Underwater", "헤이즈 (Heize)", CategoryType.HIPHOP, hiphop_lyrics13, "2019.05", "헤이즈 (Heize) - And July.jpg", "헤이즈 (Heize) - Underwater.mp3"),
//					new Song( "세레나데", "창모", CategoryType.HIPHOP, hiphop_lyrics14, "2019.11", "창모 - METEOR.png", "창모 - 세레나데.mp3"),
//					new Song( "호구 (FEAT.브라더수)", "기리보이", CategoryType.HIPHOP, hiphop_lyrics15, "2015.12", "기리보이 - 호구 (FEAT.브라더수).jpg", "기리보이 - 호구 (FEAT.브라더수).mp3"),
//					new Song( "Shut Up & Groove (feat. DEAN)", "헤이즈 (Heize)", CategoryType.HIPHOP, hiphop_lyrics16, "2016.07", "헤이즈 (Heize) - And July.jpg", "헤이즈 (Heize) - Shut Up & Groove (feat. DEAN).mp3"),
//					new Song( "Ballerino (발레리노)", "리쌍", CategoryType.HIPHOP, hiphop_lyrics17, "2007.05", "리쌍 - Ballerino (발레리노) (Feat. Ali).jpg", "리쌍 - Ballerino (발레리노) (Feat. Ali).mp3"),
//					new Song( "술자리", "기리보이", CategoryType.HIPHOP, hiphop_lyrics18, "2016.11", "기리보이 - 술자리.jpg", "기리보이 - 술자리.mp3"),
//					new Song( "COCO BOTTLE", "페노메코 (PENOMECO)", CategoryType.HIPHOP, hiphop_lyrics19, "2018.08", "페노메코 (PENOMECO) - COCO BOTTLE.jpg", "페노메코 (PENOMECO) - COCO BOTTLE.mp3"),
//					new Song( "Rainy day (Feat. ASH ISLAND & Skinny Brown)", "파테코", CategoryType.HIPHOP, hiphop_lyrics20, "2020.07", "파테코 - Rainy day (Feat. ASH ISLAND & Skinny Brown).jpg", "파테코 - Rainy day (Feat. ASH ISLAND & Skinny Brown).mp3"),
//					new Song( "돌아오지마 (Feat. 용준형 of 비스트)", "헤이즈 (Heize)", CategoryType.HIPHOP, hiphop_lyrics21, "2016.04", "헤이즈 (Heize) - 돌아오지마 (Feat. 용준형 of 비스트).jpg", "헤이즈 (Heize) - 돌아오지마 (Feat. 용준형 of 비스트).mp3"),
//					new Song( "인간중독 (Feat. 유라 (youra)) (Prod. TOIL)", "릴러말즈 & TOIL", CategoryType.HIPHOP, hiphop_lyrics22, "2020.02", "릴러말즈 & TOIL - 인간중독 (Feat. 유라 (youra)) (Prod. TOIL).jpg", "릴러말즈 & TOIL - 인간중독 (Feat. 유라 (youra)) (Prod. TOIL).mp3"),
//					new Song( "party (SHUT DOWN) (Feat. 크러쉬)", "식케이 (Sik-K)", CategoryType.HIPHOP, hiphop_lyrics23, "2017.06", "식케이 (Sik-K) - party (SHUT DOWN) (Feat. 크러쉬).jpg", "식케이 (Sik-K) - party (SHUT DOWN) (Feat. 크러쉬).mp3"),
//					new Song( "GONE (Feat. Paloalto) (Prod. TOIL)", "릴러말즈 & TOIL", CategoryType.HIPHOP, hiphop_lyrics24, "2020.03", "릴러말즈 & TOIL - GONE (Feat. Paloalto) (Prod. TOIL).jpg", "릴러말즈 & TOIL - GONE (Feat. Paloalto) (Prod. TOIL).mp3"),	
//					new Song( "Merry go round (Feat. CIKI)", "uncoolclub", CategoryType.HIPHOP, hiphop_lyrics25, "2018.02", "uncoolclub - Merry go round (Feat. CIKI).jpg", "uncoolclub - Merry go round (Feat. CIKI).mp3"),
//					
//							
//					
//					// POP
//					new Song( "Celebrity", "IU (아이유)", CategoryType.POP, pop_lyrics1, "2021.03", "IU (아이유) - 라일락.png", "IU (아이유) - Celebrity.mp3"),
//					new Song( "Blueming", "IU (아이유)", CategoryType.POP, pop_lyrics2, "2019.11", "IU (아이유) - Blueming.png", "IU (아이유) - Blueming.mp3"),
//					new Song( "On The Ground", "ROSE (로제)", CategoryType.POP, pop_lyrics3, "2021.03", "ROSE(로제) - On The Ground.png", "ROSE(로제) - On The Ground.mp3"),
//					new Song( "Dance Monkey", "Tones And I", CategoryType.POP, pop_lyrics4, "2019.08", "Tones And I - Dance Monkey.png", "Tones And I - Dance Monkey.mp3"),
//					new Song( "2002", "Anne Marie", CategoryType.POP, pop_lyrics5, "2018.08", "Anne Marie - 2002.png", "Anne Marie - 2002.mp3"),
//					new Song( "Paris In The Rain", "Lauv", CategoryType.POP, pop_lyrics6, "2018.10", "Lauv - Paris In The Lain.png", "Lauv - Paris In The Lain.mp3"),
//					new Song( "Memories", "Maroon5", CategoryType.POP, pop_lyrics7, "2019.09", "Maroon5 - Memories.png", "Maroon5 - Memories.mp3"),
//					new Song( "에잇", "IU (아이유)", CategoryType.POP, pop_lyrics8, "2020.05", "IU (아이유) - 에잇.png", "IU (아이유) - 에잇.mp3"),
//					
//					new Song( "있잖아 (FEAT.마리오)", "IU (아이유)", CategoryType.POP, pop_lyrics9, "2009.04", "IU (아이유) - 있잖아.jpg", "IU (아이유) - 있잖아 (FEAT.마리오).mp3"),
//					new Song( "L*** Is A Bad Word", "Kiiara", CategoryType.POP, pop_lyrics10, "2018.10", "Kiiara - L___ Is A Bad Word.jpg", "Kiiara - L___ Is A Bad Word.mp3"), // 특수문자 사용불가로 L*** -> L___
//					new Song( "Cradles", "Sub Urban", CategoryType.POP, pop_lyrics11, "2019.01", "Sub Urban - Cradles.jpg", "Sub Urban - Cradles.mp3"),
//					new Song( "Going Up The Coast", "Clay And Friends", CategoryType.POP, pop_lyrics12, "2019.05", "Clay And Friends - Going Up The Coast.jpg", "Clay And Friends - Going Up The Coast.mp3"),
//					new Song( "Supalonely", "BENEE", CategoryType.POP, pop_lyrics13, "2019.11", "BENEE - Supalonely.jpg", "BENEE - Supalonely.mp3"),
//					new Song( "Hard to Say Goodbye", "Johnny Stimson", CategoryType.POP, pop_lyrics14, "2020.03", "Johnny Stimson - Hard to Say Goodbye.jpg", "Johnny Stimson - Hard to Say Goodbye.mp3"),
//					new Song( "High", "5 Seconds Of Summer", CategoryType.POP, pop_lyrics15, "2020.08", "5 Seconds Of Summer - High.jpg", "5 Seconds Of Summer - High.mp3"),
//					new Song( "Get Stüpid", "bülow", CategoryType.POP, pop_lyrics16, "2019.04", "bülow - Get Stüpid.jpg", "bülow - Get Stüpid.mp3"),
//					new Song( "Brooklyn Love", "Lolo Zouaï", CategoryType.POP, pop_lyrics17, "2020.07", "Lolo Zouaï - Brooklyn Love.jpg", "Lolo Zouaï - Brooklyn Love.mp3"),
//					new Song( "Coin", "IU (아이유)", CategoryType.POP, pop_lyrics18, "2021.03", "IU (아이유) - 라일락.png", "IU (아이유) - Coin.mp3"),
//					new Song( "삐삐", "IU (아이유)", CategoryType.POP, pop_lyrics19, "2018.10", "IU (아이유) - 삐삐.jpg", "IU (아이유) - 삐삐.mp3"),
//					new Song( "Psycho (Feat. Ty Dolla $ign)", "Post Malone", CategoryType.POP, pop_lyrics20, "2018.04", "Post Malone - Psycho (Feat. Ty Dolla $ign).jpg", "Post Malone - Psycho (Feat. Ty Dolla $ign).mp3"),	
//					new Song( "벚꽃 엔딩", "버스커 버스커", CategoryType.POP, pop_lyrics21, "2012.03", "버스커 버스커 - 벚꽃 엔딩.jpg", "버스커 버스커 - 벚꽃 엔딩.mp3"),
//					new Song( "Savage Love (Laxed - Siren Beat) (Explicit Ver.)", "Jawsh 685& Jason Derülo", CategoryType.POP, pop_lyrics22, "2020.06", "Jawsh 685& Jason Derülo - Savage Love (Laxed - Siren Beat) (Explicit Ver.).jpg", "Jawsh 685& Jason Derülo - Savage Love (Laxed - Siren Beat) (Explicit Ver.).mp3"),
//					new Song( "Attention", "Charlie Puth", CategoryType.POP, pop_lyrics23, "2018.05", "Charlie Puth - Attention.jpg", "Charlie Puth - Attention.mp3"),
//					new Song( "Bad Boy", "청하 & Christopher", CategoryType.POP, pop_lyrics24, "2020.09", "청하 & Christopher - Bad Boy.jpg", "청하 & Christopher - Bad Boy.mp3"),
//					new Song( "Tango", "Abir", CategoryType.POP, pop_lyrics25, "2018.10", "Abir - Tango.jpg", "Abir - Tango.mp3"),
//					
//					
//					
//					//DANCE
//					new Song( "Dynamite", "BTS (방탄소년단)", CategoryType.DANCE, dance_lyrics1, "2020.08", "BTS (방탄소년단) - Dynamite.png", "BTS (방탄소년단) - Dynamite.mp3"),
//					new Song( "작은 것들을 위한 시", "BTS (방탄소년단)", CategoryType.DANCE, dance_lyrics2, "2019.04", "BTS (방탄 소년단) - 작은 것들을 위한 시.png", "BTS (방탄 소년단) - 작은 것들을 위한 시.mp3"),
//					new Song( "Lovesick Girls", "BLACKPINK", CategoryType.DANCE, dance_lyrics3, "2020.10", "BLACKPINK - Lovesick Girls.png", "BLACKPINK - Lovesick Girls.mp3"),
//					new Song( "How You Like That", "BLACKPINK", CategoryType.DANCE, dance_lyrics4, "2020.06", "BLACKPINK - How You Like That.png", "BLACKPINK - How You Like That.mp3"),
//					new Song( "When We Disco", "박진영", CategoryType.DANCE, dance_lyrics5, "2020.08", "박진영 - When We Disco.png", "박진영 - When We Disco.mp3"),
//					new Song( "롤린 (Rollin)", "브레이브걸스", CategoryType.DANCE, dance_lyrics6, "2017.03", "브레이브걸스 - 롤린 (Rollin).png", "브레이브걸스 - 롤린 (Rollin).mp3"),
//					new Song( "운전만해", "브레이브걸스", CategoryType.DANCE, dance_lyrics7, "2020.08", "브레이브걸스 - 운전만해.png", "브레이브걸스 - 운전만해.mp3"),
//					
//					new Song( "있잖아 (ROCK VER.)", "IU (아이유)", CategoryType.DANCE, dance_lyrics8, "2009.04", "IU (아이유) - 있잖아.jpg", "IU (아이유) - 있잖아 (ROCK VER.).mp3"),
//					new Song( "Dolphin", "오마이걸 (OH MY GIRL)", CategoryType.DANCE, dance_lyrics9, "2020.04", "오마이걸 (OH MY GIRL) - Dolphin.jpg", "오마이걸 (OH MY GIRL) - Dolphin.mp3"),
//					new Song( "분홍신", "IU (아이유)", CategoryType.DANCE, dance_lyrics10, "2013.10", "IU (아이유) - 분홍신.jpg", "IU (아이유) - 분홍신.mp3"),
//					new Song( "스물셋", "IU (아이유)", CategoryType.DANCE, dance_lyrics11, "2015.10", "IU (아이유) - 스물셋.jpg", "IU (아이유) - 스물셋.mp3"),
//					new Song( "Psycho", "Red Velvet (레드벨벳)", CategoryType.DANCE, dance_lyrics12, "2019.12", "Red Velvet (레드벨벳) - Psycho.jpg", "Red Velvet (레드벨벳) - Psycho.mp3"),
//					new Song( "너랑 나", "IU (아이유)", CategoryType.DANCE, dance_lyrics13, "2011.11", "IU (아이유) - 너랑 나.jpg", "IU (아이유) - 너랑 나.mp3"),
//					new Song( "I'm Not Cool", "현아", CategoryType.DANCE, dance_lyrics14, "2021.01", "현아 - I'm Not Cool.jpg", "현아 - I'm Not Cool.mp3"),
//					new Song( "꼬리 (TAIL)", "선미", CategoryType.DANCE, dance_lyrics15, "2021.02", "선미 - 꼬리 (TAIL).jpg", "선미 - 꼬리 (TAIL).mp3"),
//					new Song( "I CAN’T STOP ME", "TWICE (트와이스)", CategoryType.DANCE, dance_lyrics16, "2020.10", "TWICE (트와이스) - I CAN’T STOP ME.jpg", "TWICE (트와이스) - I CAN’T STOP ME.mp3"),
//					new Song( "Panorama", "IZ*ONE (아이즈원)", CategoryType.DANCE, dance_lyrics17, "2020.12", "IZONE (아이즈원) - Panorama.jpg", "IZONE (아이즈원) - Panorama.mp3"),// 특수문자 사용불가로 IZ*ONE -> IZONE
//					new Song( "LOVE DAY (2021) (바른연애 길잡이 X 양요섭, 정은지)", "양요섭 & 정은지", CategoryType.DANCE, dance_lyrics18, "2021.03", "양요섭 & 정은지 - LOVE DAY (2021) (바른연애 길잡이 X 양요섭, 정은지).jpg", "양요섭 & 정은지 - LOVE DAY (2021) (바른연애 길잡이 X 양요섭, 정은지).mp3"),
//					new Song( "하루 끝", "IU (아이유)", CategoryType.DANCE, dance_lyrics19, "2012.05", "IU (아이유) - 하루 끝.jpg", "IU (아이유) - 하루 끝.mp3"),
//					new Song( "Not Shy", "ITZY (있지)", CategoryType.DANCE, dance_lyrics20, "2020.08", "ITZY (있지) - Not Shy.jpg", "ITZY (있지) - Not Shy.mp3"),
//					new Song( "보라빛 밤 (pporappippam)", "선미", CategoryType.DANCE, dance_lyrics21, "2020.06", "선미 - 보라빛 밤 (pporappippam).jpg", "선미 - 보라빛 밤 (pporappippam).mp3"),
//					new Song( "Forever Young", "BLACKPINK", CategoryType.DANCE, dance_lyrics22, "2018.06", "BLACKPINK - Forever Young.jpg", "BLACKPINK - Forever Young.mp3"),
//					new Song( "불타오르네 (FIRE)", "BTS (방탄소년단)", CategoryType.DANCE, dance_lyrics23, "2016.05", "BTS (방탄소년단) - 불타오르네 (FIRE).jpg", "BTS (방탄소년단) - 불타오르네 (FIRE).mp3"),
//					new Song( "마지막처럼", "BLACKPINK", CategoryType.DANCE, dance_lyrics24, "2017.06", "BLACKPINK - 마지막처럼.jpg", "BLACKPINK - 마지막처럼.mp3"),
//					new Song( "Into the I-LAND", "IU (아이유)", CategoryType.DANCE, dance_lyrics25, "2020.06", "IU (아이유) - Into the I-LAND.jpg", "IU (아이유) - Into the I-LAND.mp3")
//					
//					)
//			);
//		};
